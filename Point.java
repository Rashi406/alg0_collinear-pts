...
public class Point implements Comparable<Point> {
    ...
    private class Comparable implements Comparator<Point> {
    ...
    /**
     * You should not call the hashCode() method on this assignment. This means
     * that you should not use java.util.HashMap or java.util.HashSet.
     *
     * @return a string representation of this point
     */
